...
export default function TextParticipants() {
    ...
    return (
        <div className="w-full flex flex-row justify-end md:justify-around text-black/60 md:px-5 py-20 md:py-40 text-[18px] tracking-[2px] leading-6 ">
            ...
            <p className='uppercase md:max-w-[250px] text-[15px] md:text-[20px] px-5 md:px-0 md:pr-0 leading-5 md:leading-normal'>Impulsá tu marca con ideas creativas y <span className='text-black font-bold'>mentes estratégicas</span>.
