                    ...
                    <div className="flex flex-col w-[100%] justify-center items-start gap-5 text-[#d6ff00] md:p-20">
                        {links.map((link, index) => (
                            <div className="w-fit relative">
                                <FlipLink
                                    classNameMobile='text-[40px] uppercase sm:text-[80px] md:text-[80px] lg:text-[120px]'
                                ...
                                <Image src={link.icon} width={50} height={50} alt='icon-link' className='w-[20px] xl:w-[35px] absolute -top-3 -right-5 xl:-top-5 xl:-right-8' />
                            </div>
